...
public class Search extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)throws IOException {
        ...
        try {
            ...
            preparedStatement.setString(2,"http://localhost:8080/untitled2/Search?keyword="+keyword);
            preparedStatement.executeUpdate();

            //getting results after running in ranking query
            ...
            //transferring values from result set to result arraylist
            while (resultSet.next()) {
                SearchResult searchResult = new SearchResult();
                searchResult.setTile(resultSet.getString("pageTitle"));
